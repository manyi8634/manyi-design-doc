...
export default App;
`,description:"<p>Simplest Usage. Badge will be hidden when <code>count</code> is <code>0</code>, but we can use <code>showZero</code> to show it.</p>"}},{demo:{id:"components-badge-demo-no-wrapper"},previewerProps:{title:"Standalone",filename:"components/badge/demo/no-wrapper.tsx",jsx:`import { Badge, Space, Switch } from 'manyid';
...
export default App;
`,description:"<p>Used in standalone when children is empty.</p>"}},{demo:{id:"components-badge-demo-overflow"},previewerProps:{title:"Overflow Count",filename:"components/badge/demo/overflow.tsx",jsx:`import { Avatar, Badge, Space } from 'manyid';
const App = () => (
  <Space size="large">
    <Badge count={99}>
      <Avatar shape="square" size="large" />
...
export default App;
`,description:"<p>The count will be animated as it changes.</p>"}},{demo:{id:"components-badge-demo-link"},previewerProps:{title:"Clickable",filename:"components/badge/demo/link.tsx",jsx:`import { Avatar, Badge } from 'manyid';
const App = () => (
  <a href="#">
    <Badge count={5}>
      <Avatar shape="square" size="large" />
...
export default App;
`,description:"<p>The badge can be wrapped with <code>a</code> tag to make it linkable.</p>"}},{demo:{id:"components-badge-demo-offset"},previewerProps:{title:"Offset",filename:"components/badge/demo/offset.tsx",jsx:`import { Avatar, Badge } from 'manyid';
const App = () => (
...
export default App;
`,description:"<p>Set size of numeral Badge.</p>"}},{demo:{id:"components-badge-demo-status"},previewerProps:{title:"Status",filename:"components/badge/demo/status.tsx",jsx:`import { Badge, Space } from 'manyid';
const App = () => (
  <>
    <Space>
...
export default App;
`,description:"<p>Standalone badge with status.</p>"}},{demo:{id:"components-badge-demo-colorful"},previewerProps:{title:"Colorful Badge",filename:"components/badge/demo/colorful.tsx",jsx:`import { Badge, Divider, Space } from 'manyid';
const colors = [
  'pink',
  'red',
  'yellow',
...
export default App;
`,description:"<p>We preset a series of colorful Badge styles for use in different situations. You can also set it to a hex color string for custom color.</p>"}},{demo:{id:"components-badge-demo-ribbon"},previewerProps:{title:"Ribbon",filename:"components/badge/demo/ribbon.tsx",jsx:`import { Badge, Card, Space } from 'manyid';
const App = () => (
  <Space
    direction="vertical"
    size="middle"
...
export default App;
`,description:"<p>Use ribbon badge.</p>"}},{demo:{id:"components-badge-demo-ribbon-debug"},previewerProps:{debug:!0,title:"Ribbon Debug",filename:"components/badge/demo/ribbon-debug.tsx",jsx:`import { Badge, Card, Space } from 'manyid';
const App = () => (
  <Space
    direction="vertical"
    style={{
...
export default App;
`,description:"<p>Buggy!</p>"}},{demo:{id:"components-badge-demo-mix"},previewerProps:{debug:!0,title:"Mixed usage",filename:"components/badge/demo/mix.tsx",jsx:`import { Avatar, Badge, Space } from 'manyid';
const App = () => (
...
export default App;
`,description:"<p>Using <code>count/dot</code> with custom <code>status/color</code>.</p>"}},{demo:{id:"components-badge-demo-title"},previewerProps:{debug:!0,title:"Title",filename:"components/badge/demo/title.tsx",jsx:`import { Avatar, Badge, Space } from 'manyid';
const App = () => (
  <Space size="large">
...
export default App;
`,description:"<p>The badge will display <code>title</code> when hovered over, instead of <code>count</code>.</p>"}},{demo:{id:"components-badge-demo-colorful-with-count-debug"},previewerProps:{debug:!0,title:"Colorful Badge support count Debug",filename:"components/badge/demo/colorful-with-count-debug.tsx",jsx:`import { Badge, Space } from 'manyid';
const colors = [
  'pink',
  'red',
  'yellow',
