"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[3154],{470030:function(m,o,n){n.r(o);var r=n(502143),p=n(968521),c=n(659378),f=n(631007),_=n(374912),a=n(828089),h=n(902068),v=n(574399),x=n(863942),E=n(316073),Z=n(24628),g=n(719260),P=n(956140),A=n(833531),l=n(905388),D=n(626643),M=n(606965),O=n(249706),C=n(795127),B=n(116846),y=n(73024),i=n(606641),s=n(667294),t=n(370917);function d(){var u=(0,i.eL)(),e=u.texts;return(0,t.tZ)(i.dY,null,(0,t.tZ)(s.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,e[0].value),(0,t.tZ)("h2",{id:"when-to-use"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,t.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,t.tZ)("p",null,e[1].value),(0,t.tZ)("p",null,e[2].value),(0,t.tZ)("h2",{id:"examples"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,t.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,t.tZ)(l.Z,{items:[{demo:{id:"components-affix-demo-basic"},previewerProps:{title:"Basic",filename:"components/affix/demo/basic.tsx",jsx:`import { Affix, Button } from 'manyid';
...
export default App;
`,description:"<p>The simplest usage.</p>"}},{demo:{id:"components-affix-demo-on-change"},previewerProps:{title:"Callback",filename:"components/affix/demo/on-change.tsx",jsx:`import { Affix, Button } from 'manyid';
const App = () => (
...
export default App;
`,description:"<p>Callback with affixed state.</p>"}},{demo:{id:"components-affix-demo-target"},previewerProps:{title:"Container to scroll.",filename:"components/affix/demo/target.tsx",jsx:`import { Affix, Button } from 'manyid';
import { useState } from 'react';
const App = () => {
...
}`}},{demo:{id:"components-affix-demo-debug"},previewerProps:{debug:!0,title:"debug",filename:"components/affix/demo/debug.tsx",jsx:`import { Affix, Button } from 'manyid';
import { useState } from 'react';
const App = () => {
  const [top, setTop] = useState(10);
  return (
