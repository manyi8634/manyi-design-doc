...
export default App;
`,description:"<p>The simplest usage.</p>"}},{demo:{id:"components-tooltip-demo-placement"},previewerProps:{title:"Placement",filename:"components/tooltip/demo/placement.tsx",jsx:`import { Button, Tooltip } from 'manyid';
...
#components-tooltip-demo-placement .ant-btn {
  margin-left: 8px;
  margin-right: 0;
}`}},{demo:{id:"components-tooltip-demo-arrow"},previewerProps:{title:"Arrow",filename:"components/tooltip/demo/arrow.tsx",jsx:`import { Button, Divider, Segmented, Tooltip } from 'manyid';
...
export default App;
`,description:"<p>Support show, hide or keep arrow in the center.</p>"}},{demo:{id:"components-tooltip-demo-shift"},previewerProps:{iframe:"200",title:"Auto Shift",filename:"components/tooltip/demo/shift.tsx",jsx:`import { Button, Tooltip } from 'manyid';
...
export default App;
`,description:"<p>Adjust placement automatically when tooltip is invisible.</p>"}},{demo:{id:"components-tooltip-demo-destroy-tooltip-on-hide"},previewerProps:{debug:!0,title:"Destroy tooltip when hidden",filename:"components/tooltip/demo/destroy-tooltip-on-hide.tsx",jsx:`import { Tooltip } from 'manyid';
const App = () => (
...
export default App;
`,description:"<p>Setting <code>destroyTooltipOnHide</code> to control whether destroy dom node of tooltip when hidden.</p>"}},{demo:{id:"components-tooltip-demo-colorful"},previewerProps:{title:"Colorful Tooltip",filename:"components/tooltip/demo/colorful.tsx",jsx:`import { Button, Divider, Space, Tooltip } from 'manyid';
const colors = [
  'pink',
  'red',
  'yellow',
...
export default App;
`,description:"<p>We preset a series of colorful Tooltip styles for use in different situations.</p>"}},{demo:{id:"components-tooltip-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/tooltip/demo/render-panel.tsx",jsx:`import { Tooltip } from 'manyid';
...
export default App;
`,description:"<p>Debug usage. Do not use in your production.</p>"}},{demo:{id:"components-tooltip-demo-debug"},previewerProps:{debug:!0,title:"Debug",filename:"components/tooltip/demo/debug.tsx",jsx:`import { Button, Tooltip } from 'manyid';
const App = () => (
  <Tooltip
    open
