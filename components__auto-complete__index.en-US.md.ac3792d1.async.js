"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[4147],{760977:function(i,l,e){e.r(l);var p=e(502143),m=e(968521),c=e(659378),_=e(631007),v=e(374912),o=e(828089),Z=e(902068),h=e(574399),x=e(863942),g=e(316073),y=e(24628),A=e(719260),C=e(956140),E=e(833531),u=e(905388),f=e(626643),I=e(606965),P=e(249706),O=e(795127),S=e(116846),D=e(73024),a=e(606641),s=e(667294),t=e(370917);function d(){var r=(0,a.eL)(),n=r.texts;return(0,t.tZ)(a.dY,null,(0,t.tZ)(s.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,n[0].value),(0,t.tZ)("h2",{id:"when-to-use"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,t.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,t.tZ)("ul",null,(0,t.tZ)("li",null,n[1].value),(0,t.tZ)("li",null,n[2].value)),(0,t.tZ)("p",null,n[3].value),(0,t.tZ)("ul",null,(0,t.tZ)("li",null,n[4].value,(0,t.tZ)("strong",null,n[5].value),n[6].value),(0,t.tZ)("li",null,n[7].value,(0,t.tZ)("strong",null,n[8].value),n[9].value)),(0,t.tZ)("h2",{id:"examples"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,t.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,t.tZ)(u.Z,{items:[{demo:{id:"components-auto-complete-demo-basic"},previewerProps:{title:"Basic Usage",filename:"components/auto-complete/demo/basic.tsx",jsx:`import { AutoComplete } from 'manyid';
...
export default App;
`,description:"<p>Basic Usage, set data source of autocomplete with <code>options</code> property.</p>"}},{demo:{id:"components-auto-complete-demo-options"},previewerProps:{title:"Customized",filename:"components/auto-complete/demo/options.tsx",jsx:`import { AutoComplete } from 'manyid';
import { useState } from 'react';
const App = () => {
  const [options, setOptions] = useState([]);
...
export default App;
`,description:"<p>You could set custom <code>Option</code> label</p>"}},{demo:{id:"components-auto-complete-demo-custom"},previewerProps:{title:"Customize Input Component",filename:"components/auto-complete/demo/custom.tsx",jsx:`import { AutoComplete, Input } from 'manyid';
import { useState } from 'react';
...
export default App;
`,description:"<p>Customize Input Component</p>"}},{demo:{id:"components-auto-complete-demo-non-case-sensitive"},previewerProps:{title:"Non-case-sensitive AutoComplete",filename:"components/auto-complete/demo/non-case-sensitive.tsx",jsx:`import { AutoComplete } from 'manyid';
const options = [
  {
...
.certain-category-search-dropdown .ant-select-dropdown-menu {
  max-height: 300px;
}`}},{demo:{id:"components-auto-complete-demo-uncertain-category"},previewerProps:{title:"Lookup-Patterns - Uncertain Category",filename:"components/auto-complete/demo/uncertain-category.tsx",jsx:`import { AutoComplete, Input } from 'manyid';
import { useState } from 'react';
...
export default App;
`,description:'<p>Demonstration of <a href="https://ant.design/docs/spec/reaction#lookup-patterns">Lookup Patterns: Uncertain Category</a>.</p>'}},{demo:{id:"components-auto-complete-demo-status"},previewerProps:{title:"Status",filename:"components/auto-complete/demo/status.tsx",jsx:`import { AutoComplete, Space } from 'manyid';
import { useState } from 'react';
const mockVal = (str, repeat = 1) => ({
  value: str.repeat(repeat),
});
...
export default App;
`}},{demo:{id:"components-auto-complete-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/auto-complete/demo/render-panel.tsx",jsx:`import { AutoComplete, Space, Switch } from 'manyid';
