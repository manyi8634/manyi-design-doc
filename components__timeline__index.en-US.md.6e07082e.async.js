"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[6812],{206783:function(u,i,t){t.r(i);var c=t(502143),p=t(968521),v=t(659378),h=t(631007),d=t(374912),o=t(828089),a=t(902068),Z=t(574399),g=t(863942),E=t(316073),C=t(24628),x=t(719260),f=t(956140),T=t(833531),s=t(905388),P=t(626643),O=t(606965),M=t(249706),b=t(795127),D=t(116846),y=t(73024),l=t(606641),r=t(667294),e=t(370917);function m(){var _=(0,l.eL)(),n=_.texts;return(0,e.tZ)(l.dY,null,(0,e.tZ)(r.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value),(0,e.tZ)("li",null,n[2].value))),(0,e.tZ)(a.Z,{message:"After version 5.2.0, we provide a simpler usage <Timeline items={[...]} /> with better performance and potential of writing simpler code style in your applications. Meanwhile, we deprecated the old usage in browser console, we will remove it in manyid 6.0."}),(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)(d.Z,{lang:"jsx"},n[3].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(s.Z,{items:[{demo:{id:"components-timeline-demo-basic"},previewerProps:{title:"Basic",filename:"components/timeline/demo/basic.tsx",jsx:`import { Timeline } from 'manyid';
const App = () => (
  <Timeline
    items={[
      {
...
export default App;
`,description:"<p>Set the color of circles. <code>green</code> means completed or success status, <code>red</code> means warning or error, and <code>blue</code> means ongoing or other default status, <code>gray</code> for unfinished or disabled status.</p>"}},{demo:{id:"components-timeline-demo-pending"},previewerProps:{title:"Last node and Reversing",filename:"components/timeline/demo/pending.tsx",jsx:`import { Button, Timeline } from 'manyid';
...
export default App;
`,description:"<p>Right alternate timeline.</p>"}},{demo:{id:"components-timeline-demo-label"},previewerProps:{title:"Label",filename:"components/timeline/demo/label.tsx",jsx:`import { Radio, Timeline } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>Use <code>label</code> show time alone.</p>"}},{demo:{id:"components-timeline-demo-wireframe"},previewerProps:{debug:!0,title:"Wireframe",filename:"components/timeline/demo/wireframe.tsx",jsx:`import { ConfigProvider, Timeline } from 'manyid';
const App = () => (
  <ConfigProvider
    theme={{
      token: {
