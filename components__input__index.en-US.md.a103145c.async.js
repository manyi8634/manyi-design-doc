"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[158],{607278:function(s,u,e){e.r(u);var c=e(502143),m=e(968521),h=e(659378),v=e(631007),o=e(374912),l=e(828089),Z=e(902068),f=e(574399),_=e(863942),x=e(316073),g=e(24628),I=e(719260),b=e(956140),y=e(833531),i=e(905388),w=e(626643),S=e(606965),C=e(249706),O=e(795127),A=e(116846),E=e(73024),a=e(606641),p=e(667294),n=e(370917);function r(){var d=(0,a.eL)(),t=d.texts;return(0,n.tZ)(a.dY,null,(0,n.tZ)(p.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,t[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,t[1].value),(0,n.tZ)("li",null,t[2].value)),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(i.Z,{items:[{demo:{id:"components-input-demo-basic"},previewerProps:{title:"Basic usage",filename:"components/input/demo/basic.tsx",jsx:`import { Input } from 'manyid';
...
export default App;
`,description:"<p>Using pre &#x26; post tabs example.</p>"}},{demo:{id:"components-input-demo-compact-style"},previewerProps:{title:"Compact Style",filename:"components/input/demo/compact-style.tsx",jsx:`import { Button, Input, Select, Space } from 'manyid';
const { Search } = Input;
const options = [
  {
    value: 'zhejiang',
...
export default App;
`,description:"<p>Example of creating a search box by grouping a standard input with a search button.</p>"}},{demo:{id:"components-input-demo-search-input-loading"},previewerProps:{title:"Search box with loading",filename:"components/input/demo/search-input-loading.tsx",jsx:`import { Input } from 'manyid';
const { Search } = Input;
const App = () => (
  <>
...
export default App;
`,description:"<p>Search loading when onSearch.</p>"}},{demo:{id:"components-input-demo-textarea"},previewerProps:{title:"TextArea",filename:"components/input/demo/textarea.tsx",jsx:`import { Input } from 'manyid';
...
export default App;
`,description:"<p>For multi-line input.</p>"}},{demo:{id:"components-input-demo-autosize-textarea"},previewerProps:{title:"Autosizing the height to fit the content",filename:"components/input/demo/autosize-textarea.tsx",jsx:`import { Input } from 'manyid';
...
export default App;
`,description:"<p>Input type of password.</p>"}},{demo:{id:"components-input-demo-allowclear"},previewerProps:{title:"With clear icon",filename:"components/input/demo/allowClear.tsx",jsx:`import { Input } from 'manyid';
const { TextArea } = Input;
const onChange = (e) => {
  console.log(e);
};
...
export default App;
`,description:"<p>Input box with the remove icon, click the icon to delete everything.</p>"}},{demo:{id:"components-input-demo-show-count"},previewerProps:{title:"With character counting",filename:"components/input/demo/show-count.tsx",jsx:`import { Input } from 'manyid';
const { TextArea } = Input;
const onChange = (e) => {
...
export default App;
`,description:"<p>Show character counting.</p>"}},{demo:{id:"components-input-demo-textarea-show-count"},previewerProps:{title:"Textarea with character counting",filename:"components/input/demo/textarea-show-count.tsx",jsx:`import { Input } from 'manyid';
const { TextArea } = Input;
const onChange = (e) => {
  console.log('Change:', e.target.value);
};
...
export default App;
`,description:"<p>Add status to Input with <code>status</code>, which could be <code>error</code> or <code>warning</code>.</p>"}},{demo:{id:"components-input-demo-borderless"},previewerProps:{title:"Borderless",filename:"components/input/demo/borderless.tsx",jsx:`import { Input } from 'manyid';
const App = () => <Input placeholder="Borderless" bordered={false} />;
export default App;
`,description:"<p>No border.</p>"}},{demo:{id:"components-input-demo-focus"},previewerProps:{title:"Focus",filename:"components/input/demo/focus.tsx",jsx:`import { Button, Input, Space, Switch } from 'manyid';
...
export default App;
`,description:"<p>Focus with additional option.</p>"}},{demo:{id:"components-input-demo-borderless-debug"},previewerProps:{debug:!0,title:"Style Debug",filename:"components/input/demo/borderless-debug.tsx",jsx:`import { Input } from 'manyid';
const { TextArea } = Input;
const App = () => (
  <div
    style={{
...
export default App;
`}},{demo:{id:"components-input-demo-textarea-resize"},previewerProps:{debug:!0,title:"TextArea",filename:"components/input/demo/textarea-resize.tsx",jsx:`import { Button, Input } from 'manyid';
import { useState } from 'react';
const { TextArea } = Input;
const defaultValue =
