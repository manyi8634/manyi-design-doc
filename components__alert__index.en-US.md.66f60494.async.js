"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[7743],{388652:function(d,o,t){t.r(o);var u=t(502143),p=t(968521),m=t(659378),_=t(631007),v=t(374912),l=t(828089),Z=t(902068),g=t(574399),E=t(863942),h=t(316073),x=t(24628),A=t(719260),y=t(956140),f=t(833531),i=t(905388),D=t(626643),I=t(606965),T=t(249706),P=t(795127),b=t(116846),w=t(73024),r=t(606641),s=t(667294),e=t(370917);function a(){var c=(0,r.eL)(),n=c.texts;return(0,e.tZ)(r.dY,null,(0,e.tZ)(s.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value),(0,e.tZ)("li",null,n[2].value)),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(i.Z,{items:[{demo:{id:"components-alert-demo-basic"},previewerProps:{title:"Basic",filename:"components/alert/demo/basic.tsx",jsx:`import { Alert } from 'manyid';
const App = () => <Alert message="Success Text" type="success" />;
export default App;
`,description:"<p>The simplest usage for short messages.</p>"}},{demo:{id:"components-alert-demo-style"},previewerProps:{title:"More types",filename:"components/alert/demo/style.tsx",jsx:`import { Alert, Space } from 'manyid';
const App = () => (
  <Space
    direction="vertical"
    style={{
...
export default App;
`,description:"<p>There are 4 types of Alert: <code>success</code>, <code>info</code>, <code>warning</code>, <code>error</code>.</p>"}},{demo:{id:"components-alert-demo-closable"},previewerProps:{title:"Closable",filename:"components/alert/demo/closable.tsx",jsx:`import { Alert, Space } from 'manyid';
const onClose = (e) => {
...
export default App;
`,description:"<p>To show close button.</p>"}},{demo:{id:"components-alert-demo-description"},previewerProps:{title:"Description",filename:"components/alert/demo/description.tsx",jsx:`import { Alert, Space } from 'manyid';
const App = () => (
  <Space
    direction="vertical"
    style={{
...
export default App;
`,description:"<p>Additional description for alert message.</p>"}},{demo:{id:"components-alert-demo-icon"},previewerProps:{title:"Icon",filename:"components/alert/demo/icon.tsx",jsx:`import { Alert, Space } from 'manyid';
const App = () => (
  <Space
    direction="vertical"
    style={{
...
export default App;
`,description:"<p>A relevant icon will make information clearer and more friendly.</p>"}},{demo:{id:"components-alert-demo-close-text"},previewerProps:{title:"Customized Close Text",filename:"components/alert/demo/close-text.tsx",jsx:`import { Alert } from 'manyid';
const App = () => <Alert message="Info Text" type="info" closeText="Close Now" />;
export default App;
`,description:"<p>Replace the default icon with customized text.</p>"}},{demo:{id:"components-alert-demo-banner"},previewerProps:{iframe:"250",title:"Banner",filename:"components/alert/demo/banner.tsx",jsx:`import { Alert, Space } from 'manyid';
const App = () => (
  <Space
    direction="vertical"
    style={{
...
export default App;
`,description:"<p>Display Alert as a banner at top of page.</p>"}},{demo:{id:"components-alert-demo-loop-banner"},previewerProps:{title:"Loop Banner",filename:"components/alert/demo/loop-banner.tsx",jsx:`import { Alert } from 'manyid';
...
export default App;
`,description:'<p>Show a loop banner by using with <a href="https://npmjs.com/package/react-text-loop-next">react-text-loop-next</a> or <a href="https://npmjs.com/package/react-fast-marquee">react-fast-marquee</a>.</p>'}},{demo:{id:"components-alert-demo-smooth-closed"},previewerProps:{title:"Smoothly Unmount",filename:"components/alert/demo/smooth-closed.tsx",jsx:`import { Alert, Space, Switch } from 'manyid';
...
export default App;
`,description:"<p>Smoothly unmount Alert upon close.</p>"}},{demo:{id:"components-alert-demo-error-boundary"},previewerProps:{title:"ErrorBoundary",filename:"components/alert/demo/error-boundary.tsx",jsx:`import { Alert, Button } from 'manyid';
import { useState } from 'react';
...
export default App;
`,description:"<p>A relevant icon makes information clearer and more friendly.</p>"}},{demo:{id:"components-alert-demo-action"},previewerProps:{title:"Custom action",filename:"components/alert/demo/action.tsx",jsx:`import { Alert, Button, Space } from 'manyid';
const App = () => (
  <Space
    direction="vertical"
    style={{
