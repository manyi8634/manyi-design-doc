"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[8059],{438966:function(r,i,e){e.r(i);var m=e(502143),c=e(968521),p=e(659378),v=e(631007),_=e(374912),a=e(828089),Z=e(902068),g=e(574399),h=e(863942),f=e(316073),L=e(24628),y=e(719260),E=e(956140),x=e(833531),o=e(905388),D=e(626643),I=e(606965),M=e(249706),T=e(795127),A=e(116846),P=e(73024),l=e(606641),d=e(667294),t=e(370917);function s(){var u=(0,l.eL)(),n=u.texts;return(0,t.tZ)(l.dY,null,(0,t.tZ)(d.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,n[0].value),(0,t.tZ)("h2",{id:"when-to-use"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,t.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,t.tZ)("p",null,n[1].value),(0,t.tZ)("h2",{id:"examples"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,t.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,t.tZ)(o.Z,{items:[{demo:{id:"components-list-demo-simple"},previewerProps:{title:"Simple list",filename:"components/list/demo/simple.tsx",jsx:`import { Divider, List, Typography } from 'manyid';
const data = [
...
export default App;
`,description:`<p>Manyi Design supports a default list size as well as a large and small size.</p>
...
<p>Customizing the header and footer of list by setting <code>header</code> and <code>footer</code> property.</p>`}},{demo:{id:"components-list-demo-basic"},previewerProps:{title:"Basic list",filename:"components/list/demo/basic.tsx",jsx:`import { Avatar, List } from 'manyid';
const data = [
  {
...
export default App;
`,description:"<p>Basic list.</p>"}},{demo:{id:"components-list-demo-loadmore"},previewerProps:{title:"Load more",filename:"components/list/demo/loadmore.tsx",jsx:`import { Avatar, Button, List, Skeleton } from 'manyid';
...
`,description:"<p>Load more list with <code>loadMore</code> property.</p>",style:`.demo-loadmore-list {
  min-height: 350px;
}`}},{demo:{id:"components-list-demo-vertical"},previewerProps:{title:"Vertical",filename:"components/list/demo/vertical.tsx",jsx:`import { Avatar, List, Space } from 'manyid';
...
export default App;
`,description:"<p>Set the <code>itemLayout</code> property to <code>vertical</code> to create a vertical list.</p>"}},{demo:{id:"components-list-demo-pagination"},previewerProps:{title:"Pagination Settings",filename:"components/list/demo/pagination.tsx",jsx:`import { Avatar, List, Radio, Space } from 'manyid';
...
export default App;
`,description:"<p>List pagination can be used and set through the <code>pagination</code> property.</p>"}},{demo:{id:"components-list-demo-grid"},previewerProps:{title:"Grid",filename:"components/list/demo/grid.tsx",jsx:`import { Card, List } from 'manyid';
const data = [
  {
    title: 'Title 1',
  },
...
export default App;
`,description:"<p>Create a grid layout by setting the <code>grid</code> property of List.</p>"}},{demo:{id:"components-list-demo-grid-test"},previewerProps:{debug:!0,title:"Test Grid",filename:"components/list/demo/grid-test.tsx",jsx:`import { Card, List } from 'manyid';
const data = [
  {
    title: 'Title 1',
  },
...
export default App;
`,description:"<p>Test List <code>grid</code> for some edge cases.</p>"}},{demo:{id:"components-list-demo-responsive"},previewerProps:{title:"Responsive grid list",filename:"components/list/demo/responsive.tsx",jsx:`import { Card, List } from 'manyid';
const data = [
  {
    title: 'Title 1',
  },
...
export default App;
`,description:'<p>Responsive grid list. The size property the is as same as <a href="/components/grid/#col">Layout Grid</a>.</p>'}},{demo:{id:"components-list-demo-infinite-load"},previewerProps:{title:"Scrolling loaded",filename:"components/list/demo/infinite-load.tsx",jsx:`import { Avatar, Divider, List, Skeleton } from 'manyid';
import { useEffect, useState } from 'react';
...
export default App;
`,description:'<p>The example of infinite load with <a href="https://github.com/ankeetmaini/react-infinite-scroll-component">react-infinite-scroll-component</a>.</p>'}},{demo:{id:"components-list-demo-virtual-list"},previewerProps:{title:"virtual list",filename:"components/list/demo/virtual-list.tsx",jsx:`import { Avatar, List, message } from 'manyid';
