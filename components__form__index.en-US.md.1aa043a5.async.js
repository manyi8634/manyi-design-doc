"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[6252],{868466:function(d,r,l){l.r(r);var c=l(502143),p=l(968521),v=l(659378),h=l(631007),o=l(374912),a=l(828089),Z=l(902068),f=l(574399),F=l(863942),g=l(316073),b=l(24628),I=l(719260),y=l(956140),x=l(833531),u=l(905388),C=l(626643),_=l(606965),w=l(249706),k=l(795127),S=l(116846),P=l(73024),t=l(606641),m=l(667294),n=l(370917);function i(){var s=(0,t.eL)(),e=s.texts;return(0,n.tZ)(t.dY,null,(0,n.tZ)(m.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When to use"),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,e[1].value),(0,n.tZ)("li",null,e[2].value)),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(u.Z,{items:[{demo:{id:"components-form-demo-basic"},previewerProps:{title:"Basic Usage",filename:"components/form/demo/basic.tsx",jsx:`import { Button, Checkbox, Form, Input } from 'manyid';
...
export default App;
`,description:"<p>Basic Form data control. Includes layout, initial values, validation and submit.</p>"}},{demo:{id:"components-form-demo-control-hooks"},previewerProps:{title:"Form methods",filename:"components/form/demo/control-hooks.tsx",jsx:`import { Button, Form, Input, Select } from 'manyid';
const { Option } = Select;
const layout = {
  labelCol: {
    span: 8,
...
<p>Note that <code>useForm</code> is a <a href="https://reactjs.org/docs/hooks-intro.html">React Hooks</a> that only works in functional component.</p>
  ...
  margin-right: 8px;
}`}},{demo:{id:"components-form-demo-control-ref"},previewerProps:{title:"Form methods (Class component)",filename:"components/form/demo/control-ref.tsx",jsx:`import { Button, Form, Input, Select } from 'manyid';
...
`,description:"<p>We recommend use <code>Form.useForm</code> to create data control. If you are using class component, you can get it by <code>ref</code>.</p>",style:`#components-form-demo-control-ref .ant-btn {
  margin-right: 8px;
}`}},{demo:{id:"components-form-demo-layout"},previewerProps:{title:"Form Layout",filename:"components/form/demo/layout.tsx",jsx:`import { Button, Form, Input, Radio } from 'manyid';
...
`,description:"<p>Set component disabled, only works for manyid components.</p>"}},{demo:{id:"components-form-demo-required-mark"},previewerProps:{title:"Required style",filename:"components/form/demo/required-mark.tsx",jsx:`import { InfoCircleOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>Set component size, only works for manyid components.</p>"}},{demo:{id:"components-form-demo-layout-can-wrap"},previewerProps:{title:"label can wrap",filename:"components/form/demo/layout-can-wrap.tsx",jsx:`import { Button, Form, Input } from 'manyid';
const App = () => (
  <Form
    name="wrap"
    labelCol={{
...
export default App;
`,description:"<p>Turn on <code>labelWrap</code> to wrap label if text is long.</p>"}},{demo:{id:"components-form-demo-warning-only"},previewerProps:{title:"No block rule",filename:"components/form/demo/warning-only.tsx",jsx:`import { Button, Form, Input, message, Space } from 'manyid';
const App = () => {
  const [form] = Form.useForm();
  const onFinish = () => {
...
export default App;
`,description:"<p><code>rule</code> with <code>warningOnly</code> will not block form submit.</p>"}},{demo:{id:"components-form-demo-usewatch"},previewerProps:{title:"Watch Hooks",filename:"components/form/demo/useWatch.tsx",jsx:`import { Form, Input, InputNumber, Typography } from 'manyid';
const Demo = () => {
  const [form] = Form.useForm();
...
export default Demo;
`,description:'<p><code>useWatch</code> helps watch the field change and only re-render for the value change. <a href="#formusewatch">API Ref</a>.</p>'}},{demo:{id:"components-form-demo-form-item-path"},previewerProps:{title:"Path Prefix",filename:"components/form/demo/form-item-path.tsx",jsx:`import { Button, Form, Input } from 'manyid';
import React from 'react';
...
export default App;
`,description:"<p>This example demonstrates the case that a form contains multiple form controls.</p>"}},{demo:{id:"components-form-demo-nest-messages"},previewerProps:{title:"Nest",filename:"components/form/demo/nest-messages.tsx",jsx:`import { Button, Form, Input, InputNumber } from 'manyid';
const layout = {
  labelCol: {
    span: 8,
  },
...
</blockquote>`}},{demo:{id:"components-form-demo-global-state"},previewerProps:{title:"Store Form Data into Upper Component",filename:"components/form/demo/global-state.tsx",jsx:`import { Form, Input, Typography } from 'manyid';
import { useState } from 'react';
...
import { Avatar, Button, Form, Input, InputNumber, Modal } from 'manyid';
...
<p>Because the width of label is not fixed, you may need to adjust it by customizing its style.</p>`}},{demo:{id:"components-form-demo-form-in-modal"},previewerProps:{title:"Form in Modal to Create",filename:"components/form/demo/form-in-modal.tsx",jsx:`import { Button, Form, Input, Modal, Radio } from 'manyid';
import { useState } from 'react';
...
`,description:"<p>When user visit a page with a list of items, and want to create a new item. The page can popup a form in Modal, then let user fill in the form to create an item.</p>",style:`.collection-create-form_last-form-item {
  margin-bottom: 0;
}`}},{demo:{id:"components-form-demo-time-related-controls"},previewerProps:{title:"Time-related Controls",filename:"components/form/demo/time-related-controls.tsx",jsx:`import { Button, DatePicker, Form, TimePicker } from 'manyid';
const { RangePicker } = DatePicker;
const formItemLayout = {
  labelCol: {
    xs: {
...
</ol>`}},{demo:{id:"components-form-demo-dynamic-rule"},previewerProps:{title:"Dynamic Rules",filename:"components/form/demo/dynamic-rule.tsx",jsx:`import { Button, Checkbox, Form, Input } from 'manyid';
import { useEffect, useState } from 'react';
const formItemLayout = {
  labelCol: {
    span: 4,
...
export default App;
`,description:"<p>Test disabled Input with validate state.</p>"}},{demo:{id:"components-form-demo-dep-debug"},previewerProps:{debug:!0,title:"Dep Debug",filename:"components/form/demo/dep-debug.tsx",jsx:`import { Form, Input } from 'manyid';
let acc = 0;
const App = () => {
  const [form] = Form.useForm();
  return (
...
export default App;
`,description:"<p>Buggy!</p>"}},{demo:{id:"components-form-demo-label-debug"},previewerProps:{debug:!0,title:"label ellipsis",filename:"components/form/demo/label-debug.tsx",jsx:`import { Form, Input, Typography } from 'manyid';
const App = () => (
  <Form
    name="label-ellipsis"
    labelCol={{
...
export default App;
`,description:"<p>Use <code>&#x3C;Typography.Text ellipsis></code> in label should show <code>...</code>.</p>"}},{demo:{id:"components-form-demo-col-24-debug"},previewerProps:{debug:!0,title:"Test col 24 usage",filename:"components/form/demo/col-24-debug.tsx",jsx:`import { Button, Divider, Form, Input, Select } from 'manyid';
const sharedItem = (
  <Form.Item
...
export default App;
`,description:'<p>See issue <a href="https://github.com/ant-design/ant-design/issues/32980">#32980</a>.</p>'}},{demo:{id:"components-form-demo-ref-item"},previewerProps:{debug:!0,title:"Ref item",filename:"components/form/demo/ref-item.tsx",jsx:`import { Button, Form, Input } from 'manyid';
import React from 'react';
const App = () => {
  const [form] = Form.useForm();
