"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[1544],{967950:function(c,d,e){e.r(d);var _=e(502143),p=e(968521),m=e(659378),Z=e(631007),o=e(374912),l=e(828089),v=e(902068),C=e(574399),h=e(863942),E=e(316073),y=e(24628),g=e(719260),x=e(956140),b=e(833531),i=e(905388),f=e(626643),P=e(606965),M=e(249706),A=e(795127),O=e(116846),T=e(73024),a=e(606641),r=e(667294),t=e(370917);function u(){var s=(0,a.eL)(),n=s.texts;return(0,t.tZ)(a.dY,null,(0,t.tZ)(r.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,n[0].value),(0,t.tZ)("h2",{id:"when-to-use"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,t.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,t.tZ)("p",null,n[1].value),(0,t.tZ)("h2",{id:"examples"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,t.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,t.tZ)(i.Z,{items:[{demo:{id:"components-card-demo-basic"},previewerProps:{title:"Basic card",filename:"components/card/demo/basic.tsx",jsx:`import { Card, Space } from 'manyid';
const App = () => (
...
export default App;
`,description:"<p>A borderless card on a gray background.</p>"}},{demo:{id:"components-card-demo-simple"},previewerProps:{title:"Simple card",filename:"components/card/demo/simple.tsx",jsx:`import { Card } from 'manyid';
const App = () => (
  <Card
    style={{
      width: 300,
...
export default App;
`,description:"<p>A simple card only containing a content area.</p>"}},{demo:{id:"components-card-demo-flexible-content"},previewerProps:{title:"Customized content",filename:"components/card/demo/flexible-content.tsx",jsx:`import { Card } from 'manyid';
const { Meta } = Card;
const App = () => (
  <Card
    hoverable
...
export default App;
`,description:"<p>You can use <code>Card.Meta</code> to support more flexible content.</p>"}},{demo:{id:"components-card-demo-in-column"},previewerProps:{background:"grey",title:"Card in column",filename:"components/card/demo/in-column.tsx",jsx:`import { Card, Col, Row } from 'manyid';
const App = () => (
  <Row gutter={16}>
    <Col span={8}>
...
export default App;
`,description:"<p>Shows a loading indicator while the contents of the card is being fetched.</p>"}},{demo:{id:"components-card-demo-grid-card"},previewerProps:{title:"Grid card",filename:"components/card/demo/grid-card.tsx",jsx:`import { Card } from 'manyid';
const gridStyle = {
  width: '25%',
  textAlign: 'center',
};
...
export default App;
`,description:"<p>Grid style card content.</p>"}},{demo:{id:"components-card-demo-inner"},previewerProps:{title:"Inner card",filename:"components/card/demo/inner.tsx",jsx:`import { Card } from 'manyid';
const App = () => (
  <Card title="Card title">
...
export default App;
`,description:"<p>It can be placed inside the ordinary card to display the information of the multilevel structure.</p>"}},{demo:{id:"components-card-demo-tabs"},previewerProps:{title:"With tabs",filename:"components/card/demo/tabs.tsx",jsx:`import { Card } from 'manyid';
import { useState } from 'react';
const tabList = [
  {
    key: 'tab1',
