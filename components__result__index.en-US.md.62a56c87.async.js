"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[9610],{704532:function(d,o,n){n.r(o);var r=n(502143),m=n(968521),p=n(659378),c=n(631007),E=n(374912),i=n(828089),v=n(902068),x=n(574399),y=n(863942),h=n(316073),P=n(24628),g=n(719260),Z=n(956140),B=n(833531),s=n(905388),O=n(626643),f=n(606965),C=n(249706),D=n(795127),M=n(116846),T=n(73024),l=n(606641),_=n(667294),e=n(370917);function u(){var a=(0,l.eL)(),t=a.texts;return(0,e.tZ)(l.dY,null,(0,e.tZ)(_.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,t[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("p",null,t[1].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(s.Z,{items:[{demo:{id:"components-result-demo-success"},previewerProps:{title:"Success",filename:"components/result/demo/success.tsx",jsx:`import { Button, Result } from 'manyid';
const App = () => (
  <Result
    status="success"
...
export default App;
`,description:"<p>Show successful results.</p>"}},{demo:{id:"components-result-demo-info"},previewerProps:{title:"Info",filename:"components/result/demo/info.tsx",jsx:`import { Button, Result } from 'manyid';
const App = () => (
  <Result
...
export default App;
`,description:"<p>Show processing results.</p>"}},{demo:{id:"components-result-demo-warning"},previewerProps:{title:"Warning",filename:"components/result/demo/warning.tsx",jsx:`import { Button, Result } from 'manyid';
const App = () => (
  <Result
    status="warning"
...
export default App;
`,description:"<p>The result of the warning.</p>"}},{demo:{id:"components-result-demo-403"},previewerProps:{title:"403",filename:"components/result/demo/403.tsx",jsx:`import { Button, Result } from 'manyid';
const App = () => (
  <Result
    status="403"
    title="403"
...
export default App;
`,description:"<p>you are not authorized to access this page.</p>"}},{demo:{id:"components-result-demo-404"},previewerProps:{title:"404",filename:"components/result/demo/404.tsx",jsx:`import { Button, Result } from 'manyid';
const App = () => (
  <Result
    status="404"
    title="404"
...
export default App;
`,description:"<p>The page you visited does not exist.</p>"}},{demo:{id:"components-result-demo-500"},previewerProps:{title:"500",filename:"components/result/demo/500.tsx",jsx:`import { Button, Result } from 'manyid';
const App = () => (
  <Result
    status="500"
    title="500"
