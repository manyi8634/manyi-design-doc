"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[7519],{734875:function(u,o,t){t.r(o);var c=t(502143),m=t(968521),p=t(659378),v=t(631007),g=t(374912),a=t(828089),i=t(902068),Z=t(574399),f=t(863942),E=t(316073),h=t(24628),C=t(719260),P=t(956140),x=t(833531),d=t(905388),R=t(626643),D=t(606965),M=t(249706),y=t(795127),O=t(116846),A=t(73024),l=t(606641),s=t(667294),e=t(370917);function _(){var r=(0,l.eL)(),n=r.texts;return(0,e.tZ)(l.dY,null,(0,e.tZ)(s.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value,(0,e.tZ)("code",null,n[1].value),n[2].value)),(0,e.tZ)(i.Z,{message:"If the QR code cannot be scanned for identification, it may be because the link address is too long, which leads to too dense pixels. You can configure the QR code to be larger through `size`, or shorten the link through short link services."}),(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("p",null,n[3].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(d.Z,{items:[{demo:{id:"components-qrcode-demo-base"},previewerProps:{title:"base",filename:"components/qrcode/demo/base.tsx",jsx:`import { QRCode } from 'manyid';
const App = () => <QRCode value="https://ant.design/" />;
export default App;
`,description:"<p>Basic Usage.</p>"}},{demo:{id:"components-qrcode-demo-icon"},previewerProps:{title:"With Icon",filename:"components/qrcode/demo/icon.tsx",jsx:`import { QRCode } from 'manyid';
const App = () => (
  <QRCode
    errorLevel="H"
...
export default App;
`,description:"<p>QRCode with Icon.</p>"}},{demo:{id:"components-qrcode-demo-status"},previewerProps:{title:"other status",filename:"components/qrcode/demo/status.tsx",jsx:`import { QRCode, Space } from 'manyid';
const App = () => (
  <Space wrap>
...
import { Button, QRCode } from 'manyid';
...
export default App;
`,description:"<p>Custom Size.</p>"}},{demo:{id:"components-qrcode-demo-customcolor"},previewerProps:{title:"Custom Color",filename:"components/qrcode/demo/customColor.tsx",jsx:`import { QRCode, Space, theme } from 'manyid';
...
export default App;
`,description:"<p>Custom Color.</p>"}},{demo:{id:"components-qrcode-demo-download"},previewerProps:{title:"Download QRCode",filename:"components/qrcode/demo/download.tsx",jsx:`import { Button, QRCode } from 'manyid';
...
export default App;
`,description:"<p>A way to download QRCode.</p>"}},{demo:{id:"components-qrcode-demo-errorlevel"},previewerProps:{title:"Error Level",filename:"components/qrcode/demo/errorlevel.tsx",jsx:`import { QRCode, Segmented } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>set Error Level.</p>"}},{demo:{id:"components-qrcode-demo-popover"},previewerProps:{title:"Advanced Usage",filename:"components/qrcode/demo/Popover.tsx",jsx:`import { Popover, QRCode } from 'manyid';
