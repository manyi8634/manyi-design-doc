"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[1185],{952243:function(c,a,t){t.r(a);var p=t(502143),Z=t(968521),h=t(659378),v=t(631007),d=t(374912),l=t(828089),m=t(902068),_=t(574399),y=t(863942),f=t(316073),x=t(24628),k=t(719260),g=t(956140),E=t(833531),u=t(905388),D=t(626643),O=t(606965),K=t(249706),w=t(795127),b=t(116846),P=t(73024),o=t(606641),i=t(667294),e=t(370917);function r(){var s=(0,o.eL)(),n=s.texts;return(0,e.tZ)(o.dY,null,(0,e.tZ)(i.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("p",null,n[1].value,(0,e.tZ)("code",null,n[2].value),n[3].value,(0,e.tZ)("code",null,n[4].value),n[5].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(u.Z,{items:[{demo:{id:"components-tree-demo-basic"},previewerProps:{title:"Basic",filename:"components/tree/demo/basic.tsx",jsx:`import { Tree } from 'manyid';
const treeData = [
  {
    title: 'parent 1',
    key: '0-0',
...
export default App;
`,description:"<p>The most basic usage, tell you how to use checkable, selectable, disabled, defaultExpandKeys, and etc.</p>"}},{demo:{id:"components-tree-demo-basic-controlled"},previewerProps:{title:"Controlled Tree",filename:"components/tree/demo/basic-controlled.tsx",jsx:`import { Tree } from 'manyid';
...
export default App;
`,description:"<p>Controlled mode lets parent nodes reflect the status of child nodes more intelligently.</p>"}},{demo:{id:"components-tree-demo-draggable"},previewerProps:{title:"draggable",filename:"components/tree/demo/draggable.tsx",jsx:`import { Tree } from 'manyid';
import { useState } from 'react';
const x = 3;
const y = 2;
const z = 1;
...
export default App;
`,description:"<p>Drag treeNode to insert after the other treeNode or insert into the other parent TreeNode.</p>"}},{demo:{id:"components-tree-demo-dynamic"},previewerProps:{title:"load data asynchronously",filename:"components/tree/demo/dynamic.tsx",jsx:`import { Tree } from 'manyid';
import { useState } from 'react';
const initTreeData = [
  {
...
export default App;
`,description:"<p>To load data asynchronously when click to expand a treeNode.</p>"}},{demo:{id:"components-tree-demo-search"},previewerProps:{title:"Searchable",filename:"components/tree/demo/search.tsx",jsx:`import { Input, Tree } from 'manyid';
...
export default App;
`,description:"<p>You can customize icons for different nodes.</p>"}},{demo:{id:"components-tree-demo-directory"},previewerProps:{title:"directory",filename:"components/tree/demo/directory.tsx",jsx:`import { Tree } from 'manyid';
...
export default App;
`,description:"<p>customize collapse/expand icon of tree node</p>"}},{demo:{id:"components-tree-demo-virtual-scroll"},previewerProps:{title:"Virtual scroll",filename:"components/tree/demo/virtual-scroll.tsx",jsx:`import { Tree } from 'manyid';
...
import { Switch, Tree } from 'manyid';
...
export default App;
`}},{demo:{id:"components-tree-demo-big-data"},previewerProps:{debug:!0,title:"Big data",filename:"components/tree/demo/big-data.tsx",jsx:`import { Tree } from 'manyid';
const treeData = [];
...
export default App;
`,description:"<p>Plenty of tree nodes.</p>"}},{demo:{id:"components-tree-demo-block-node"},previewerProps:{title:"Block Node",filename:"components/tree/demo/block-node.tsx",jsx:`import { Tree } from 'manyid';
const treeData = [
  {
    title: 'parent',
    key: '0',
