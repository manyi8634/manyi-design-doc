"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[6274],{343078:function(p,l,t){t.r(l);var m=t(502143),s=t(968521),c=t(659378),_=t(631007),w=t(374912),d=t(828089),v=t(902068),Z=t(574399),g=t(863942),D=t(316073),b=t(24628),h=t(719260),f=t(956140),y=t(833531),r=t(905388),B=t(626643),E=t(606965),k=t(249706),O=t(795127),x=t(116846),C=t(73024),o=t(606641),a=t(667294),n=t(370917);function u(){var i=(0,o.eL)(),e=i.texts;return(0,n.tZ)(o.dY,null,(0,n.tZ)(a.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,n.tZ)("p",null,e[1].value),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,e[2].value),(0,n.tZ)("li",null,e[3].value)),(0,n.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,n.tZ)(r.Z,{items:[{demo:{id:"components-dropdown-demo-basic"},previewerProps:{title:"\u57FA\u672C",filename:"components/dropdown/demo/basic.tsx",jsx:`import { DownOutlined, SmileOutlined } from '@ant-design/icons';
...
export default App;
`,description:"<p>\u6700\u7B80\u5355\u7684\u4E0B\u62C9\u83DC\u5355\u3002</p>"}},{demo:{id:"components-dropdown-demo-placement"},previewerProps:{title:"\u5F39\u51FA\u4F4D\u7F6E",filename:"components/dropdown/demo/placement.tsx",jsx:`import { Button, Dropdown, Space } from 'manyid';
const items = [
  {
    key: '1',
    label: (
...
export default App;
`,description:"<p>\u652F\u6301 6 \u4E2A\u5F39\u51FA\u4F4D\u7F6E\u3002</p>"}},{demo:{id:"components-dropdown-demo-arrow"},previewerProps:{title:"\u7BAD\u5934",filename:"components/dropdown/demo/arrow.tsx",jsx:`import { Button, Dropdown } from 'manyid';
const items = [
  {
    key: '1',
    label: (
...
export default App;
`,description:"<p>\u5206\u5272\u7EBF\u548C\u4E0D\u53EF\u7528\u83DC\u5355\u9879\u3002</p>"}},{demo:{id:"components-dropdown-demo-arrow-center"},previewerProps:{title:"\u7BAD\u5934\u6307\u5411",filename:"components/dropdown/demo/arrow-center.tsx",jsx:`import { Button, Dropdown } from 'manyid';
const items = [
  {
    key: '1',
    label: (
...
export default App;
`,description:"<p>\u9ED8\u8BA4\u662F\u70B9\u51FB\u5173\u95ED\u83DC\u5355\uFF0C\u53EF\u4EE5\u5173\u95ED\u6B64\u529F\u80FD\u3002</p>"}},{demo:{id:"components-dropdown-demo-context-menu"},previewerProps:{title:"\u53F3\u952E\u83DC\u5355",filename:"components/dropdown/demo/context-menu.tsx",jsx:`import { Dropdown, theme } from 'manyid';
const items = [
  {
    label: '1st menu item',
    key: '1',
