...
export default App;
`,description:"<p>\u7B80\u5355\u7684\u6B65\u9AA4\u6761\u3002</p>"}},{demo:{id:"components-steps-demo-small-size"},previewerProps:{title:"\u8FF7\u4F60\u7248",filename:"components/steps/demo/small-size.tsx",jsx:`import { Steps } from 'manyid';
const App = () => (
  <Steps
    size="small"
    current={1}
...
export default App;
`,description:"<p>\u901A\u8FC7\u8BBE\u7F6E <code>items</code> \u7684 <code>icon</code> \u5C5E\u6027\uFF0C\u53EF\u4EE5\u542F\u7528\u81EA\u5B9A\u4E49\u56FE\u6807\u3002</p>"}},{demo:{id:"components-steps-demo-step-next"},previewerProps:{title:"\u6B65\u9AA4\u5207\u6362",filename:"components/steps/demo/step-next.tsx",jsx:`import { Button, message, Steps, theme } from 'manyid';
...
export default App;
`,description:"<p>\u901A\u5E38\u914D\u5408\u5185\u5BB9\u53CA\u6309\u94AE\u4F7F\u7528\uFF0C\u8868\u793A\u4E00\u4E2A\u6D41\u7A0B\u7684\u5904\u7406\u8FDB\u5EA6\u3002</p>"}},{demo:{id:"components-steps-demo-vertical"},previewerProps:{title:"\u7AD6\u76F4\u65B9\u5411\u7684\u6B65\u9AA4\u6761",filename:"components/steps/demo/vertical.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description.';
const App = () => (
  <Steps
    direction="vertical"
...
export default App;
`,description:"<p>\u7B80\u5355\u7684\u7AD6\u76F4\u65B9\u5411\u7684\u6B65\u9AA4\u6761\u3002</p>"}},{demo:{id:"components-steps-demo-vertical-small"},previewerProps:{title:"\u7AD6\u76F4\u65B9\u5411\u7684\u5C0F\u578B\u6B65\u9AA4\u6761",filename:"components/steps/demo/vertical-small.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description.';
const App = () => (
  <Steps
    direction="vertical"
...
export default App;
`,description:"<p>\u7B80\u5355\u7684\u7AD6\u76F4\u65B9\u5411\u7684\u5C0F\u578B\u6B65\u9AA4\u6761\u3002</p>"}},{demo:{id:"components-steps-demo-error"},previewerProps:{title:"\u6B65\u9AA4\u8FD0\u884C\u9519\u8BEF",filename:"components/steps/demo/error.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description';
const App = () => (
  <Steps
    current={1}
...
export default App;
`,description:"<p>\u4F7F\u7528 Steps \u7684 <code>status</code> \u5C5E\u6027\u6765\u6307\u5B9A\u5F53\u524D\u6B65\u9AA4\u7684\u72B6\u6001\u3002</p>"}},{demo:{id:"components-steps-demo-progress-dot"},previewerProps:{title:"\u70B9\u72B6\u6B65\u9AA4\u6761",filename:"components/steps/demo/progress-dot.tsx",jsx:`import { Divider, Steps } from 'manyid';
const App = () => (
  <>
    <Steps
      progressDot
...
export default App;
`,description:"<p>\u5305\u542B\u6B65\u9AA4\u70B9\u7684\u8FDB\u5EA6\u6761\u3002</p>"}},{demo:{id:"components-steps-demo-customized-progress-dot"},previewerProps:{title:"\u81EA\u5B9A\u4E49\u70B9\u72B6\u6B65\u9AA4\u6761",filename:"components/steps/demo/customized-progress-dot.tsx",jsx:`import { Popover, Steps } from 'manyid';
...
export default App;
`,description:"<p>\u4E3A\u70B9\u72B6\u6B65\u9AA4\u6761\u589E\u52A0\u81EA\u5B9A\u4E49\u5C55\u793A\u3002</p>"}},{demo:{id:"components-steps-demo-progress-dot-small"},previewerProps:{debug:!0,title:"\u8FF7\u4F60\u7248\u70B9\u72B6\u6B65\u9AA4\u6761",filename:"components/steps/demo/progress-dot-small.tsx",jsx:`import { Divider, Steps } from 'manyid';
const App = () => (
  <>
    <Steps
      progressDot
...
export default App;
`,description:"<p>\u5305\u542B\u6B65\u9AA4\u70B9\u7684\u8FDB\u5EA6\u6761\u3002</p>"}},{demo:{id:"components-steps-demo-clickable"},previewerProps:{title:"\u53EF\u70B9\u51FB",filename:"components/steps/demo/clickable.tsx",jsx:`import { Divider, Steps } from 'manyid';
import { useState } from 'react';
const App = () => {
  const [current, setCurrent] = useState(0);
...
export default App;
`,description:"<p>\u8BBE\u7F6E <code>onChange</code> \u540E\uFF0CSteps \u53D8\u4E3A\u53EF\u70B9\u51FB\u72B6\u6001\u3002</p>"}},{demo:{id:"components-steps-demo-nav"},previewerProps:{title:"\u5BFC\u822A\u6B65\u9AA4",filename:"components/steps/demo/nav.tsx",jsx:`import { Steps } from 'manyid';
import { useState } from 'react';
const App = () => {
  const [current, setCurrent] = useState(0);
  const onChange = (value) => {
...
export default App;
`,description:"<p>\u5BFC\u822A\u7C7B\u578B\u7684\u6B65\u9AA4\u6761\u3002</p>"}},{demo:{id:"components-steps-demo-progress"},previewerProps:{title:"\u5E26\u6709\u8FDB\u5EA6\u7684\u6B65\u9AA4",filename:"components/steps/demo/progress.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description.';
const App = () => (
  <Steps
    current={1}
...
export default App;
`,description:"<p>\u5E26\u6709\u8FDB\u5EA6\u7684\u6B65\u9AA4\u3002</p>"}},{demo:{id:"components-steps-demo-label-placement"},previewerProps:{title:"\u6807\u7B7E\u653E\u7F6E\u4F4D\u7F6E",filename:"components/steps/demo/label-placement.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description.';
const items = [
  {
    title: 'Finished',
...
export default App;
`,description:"<p>\u4FEE\u6539\u6807\u7B7E\u653E\u7F6E\u4F4D\u7F6E\u4E3A <code>vertical</code>\u3002</p>"}},{demo:{id:"components-steps-demo-progress-debug"},previewerProps:{debug:!0,title:"Progress Debug",filename:"components/steps/demo/progress-debug.tsx",jsx:`import { Button, Space, Steps } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>Buggy!</p>"}},{demo:{id:"components-steps-demo-steps-in-steps"},previewerProps:{debug:!0,title:"Steps \u5D4C\u5957 Steps",filename:"components/steps/demo/steps-in-steps.tsx",jsx:`import { Card, Radio, Steps } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>\u6D4B\u8BD5 Steps \u5D4C\u5957 Steps \u7684\u6837\u5F0F\u3002</p>"}},{demo:{id:"components-steps-demo-inline"},previewerProps:{title:"\u5185\u8054\u6B65\u9AA4",filename:"components/steps/demo/inline.tsx",jsx:`import { Avatar, List, Steps } from 'manyid';
const data = [
  {
...
export default App;
`,description:"<p>\u5185\u8054\u7C7B\u578B\u7684\u6B65\u9AA4\u6761\uFF0C\u9002\u7528\u4E8E\u5217\u8868\u5185\u5BB9\u573A\u666F\u4E2D\u5C55\u793A\u5BF9\u8C61\u6240\u5728\u6D41\u7A0B\u3001\u5F53\u524D\u72B6\u6001\u7684\u60C5\u51B5\u3002</p>"}},{demo:{id:"components-steps-demo-wireframe"},previewerProps:{debug:!0,title:"\u7EBF\u6846\u98CE\u683C",filename:"components/steps/demo/wireframe.tsx",jsx:`import { ConfigProvider, Steps } from 'manyid';
const description = 'This is a description.';
const App = () => (
  <ConfigProvider
    theme={{
