...
import { ConfigProvider, Menu, Switch } from 'manyid';
import { useState } from 'react';
function getItem(label, key, icon, children) {
  return {
    key,
