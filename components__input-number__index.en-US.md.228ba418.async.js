"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[9237],{71323:function(s,l,t){t.r(l);var p=t(502143),m=t(968521),c=t(659378),_=t(631007),v=t(374912),u=t(828089),Z=t(902068),h=t(574399),b=t(863942),f=t(316073),g=t(24628),x=t(719260),y=t(956140),E=t(833531),a=t(905388),I=t(626643),C=t(606965),P=t(249706),O=t(795127),N=t(116846),A=t(73024),o=t(606641),d=t(667294),e=t(370917);function i(){var r=(0,o.eL)(),n=r.texts;return(0,e.tZ)(o.dY,null,(0,e.tZ)(d.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("p",null,n[1].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(a.Z,{items:[{demo:{id:"components-input-number-demo-basic"},previewerProps:{title:"Basic",filename:"components/input-number/demo/basic.tsx",jsx:`import { InputNumber } from 'manyid';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => <InputNumber min={1} max={10} defaultValue={3} onChange={onChange} />;
export default App;
`,description:"<p>Numeric-only input box.</p>"}},{demo:{id:"components-input-number-demo-size"},previewerProps:{title:"Sizes",filename:"components/input-number/demo/size.tsx",jsx:`import { InputNumber, Space } from 'manyid';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
export default App;
`,description:"<p>Using pre &#x26; post tabs example.</p>"}},{demo:{id:"components-input-number-demo-disabled"},previewerProps:{title:"Disabled",filename:"components/input-number/demo/disabled.tsx",jsx:`import { Button, InputNumber } from 'manyid';
...
export default App;
`,description:"<p>Click the button to toggle between available and disabled states.</p>"}},{demo:{id:"components-input-number-demo-digit"},previewerProps:{title:"High precision decimals",filename:"components/input-number/demo/digit.tsx",jsx:`import { InputNumber } from 'manyid';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
export default App;
`,description:"<p>Use <code>stringMode</code> to support high precision decimals support. <code>onChange</code> will return string value instead. You need polyfill of BigInt if browser not support.</p>"}},{demo:{id:"components-input-number-demo-formatter"},previewerProps:{title:"Formatter",filename:"components/input-number/demo/formatter.tsx",jsx:`import { InputNumber, Space } from 'manyid';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
<blockquote>
<p>Here is a Intl.NumberFormat InputNumber implementation: <a href="https://codesandbox.io/s/currency-wrapper-manyid-input-3ynzo">https://codesandbox.io/s/currency-wrapper-manyid-input-3ynzo</a></p>
</blockquote>`}},{demo:{id:"components-input-number-demo-keyboard"},previewerProps:{title:"Keyboard",filename:"components/input-number/demo/keyboard.tsx",jsx:`import { Checkbox, InputNumber, Space } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>Control keyboard behavior by <code>keyboard</code>.</p>"}},{demo:{id:"components-input-number-demo-borderless"},previewerProps:{title:"Borderless",filename:"components/input-number/demo/borderless.tsx",jsx:`import { InputNumber } from 'manyid';
const App = () => <InputNumber min={1} max={10} defaultValue={3} bordered={false} />;
export default App;
`,description:"<p>No border.</p>"}},{demo:{id:"components-input-number-demo-out-of-range"},previewerProps:{title:"Out of range",filename:"components/input-number/demo/out-of-range.tsx",jsx:`import { Button, InputNumber, Space } from 'manyid';
import { useState } from 'react';
const App = () => {
...
`,description:"<p>Debug usage. Do not use in your production.</p>"}},{demo:{id:"components-input-number-demo-debug-token"},previewerProps:{debug:!0,title:"Override Component Style",filename:"components/input-number/demo/debug-token.tsx",jsx:`import { ConfigProvider, InputNumber, Space } from 'manyid';
export default () => (
  <ConfigProvider
    theme={{
      components: {
