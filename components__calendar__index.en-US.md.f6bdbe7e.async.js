"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[3880],{620761:function(_,a,t){t.r(a);var c=t(502143),m=t(968521),p=t(659378),v=t(631007),o=t(374912),d=t(828089),h=t(902068),Z=t(574399),y=t(863942),E=t(316073),g=t(24628),C=t(719260),D=t(956140),P=t(833531),s=t(905388),x=t(626643),f=t(606965),M=t(249706),O=t(795127),T=t(116846),R=t(73024),l=t(606641),u=t(667294),n=t(370917);function i(){var r=(0,l.eL)(),e=r.texts;return(0,n.tZ)(l.dY,null,(0,n.tZ)(u.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("p",null,e[1].value),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(s.Z,{items:[{demo:{id:"components-calendar-demo-basic"},previewerProps:{title:"Basic",filename:"components/calendar/demo/basic.tsx",jsx:`import { Calendar } from 'manyid';
const App = () => {
...
export default App;
`,description:"<p>A basic calendar component with Year/Month switch.</p>"}},{demo:{id:"components-calendar-demo-notice-calendar"},previewerProps:{title:"Notice Calendar",filename:"components/calendar/demo/notice-calendar.tsx",jsx:`import { Badge, Calendar } from 'manyid';
...
.notes-month section {
  font-size: 28px;
}`}},{demo:{id:"components-calendar-demo-card"},previewerProps:{title:"Card",filename:"components/calendar/demo/card.tsx",jsx:`import { Calendar, theme } from 'manyid';
const onPanelChange = (value, mode) => {
  console.log(value.format('YYYY-MM-DD'), mode);
};
const App = () => {
...
export default App;
`,description:"<p>Nested inside a container element for rendering in limited space.</p>"}},{demo:{id:"components-calendar-demo-select"},previewerProps:{title:"Selectable Calendar",filename:"components/calendar/demo/select.tsx",jsx:`import dayjs from 'dayjs';
...
export default App;
`,description:"<p>A basic calendar component with Year/Month switch.</p>"}},{demo:{id:"components-calendar-demo-customize-header"},previewerProps:{title:"Customize Header",filename:"components/calendar/demo/customize-header.tsx",jsx:`import dayjs from 'dayjs';
import 'dayjs/locale/zh-cn';
import dayLocaleData from 'dayjs/plugin/localeData';
import { Calendar, Col, Radio, Row, Select, theme, Typography } from 'manyid';
