"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[4507],{109884:function(s,l,e){e.r(l);var m=e(502143),p=e(968521),Z=e(659378),v=e(631007),o=e(374912),i=e(828089),c=e(902068),g=e(574399),P=e(863942),h=e(316073),E=e(24628),x=e(719260),C=e(956140),f=e(833531),u=e(905388),M=e(626643),A=e(606965),D=e(249706),O=e(795127),T=e(116846),y=e(73024),a=e(606641),d=e(667294),n=e(370917);function _(){var r=(0,a.eL)(),t=r.texts;return(0,n.tZ)(a.dY,null,(0,n.tZ)(d.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,t[0].value,(0,n.tZ)("code",null,t[1].value),t[2].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,t[3].value),(0,n.tZ)("li",null,t[4].value)),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(u.Z,{items:[{demo:{id:"components-pagination-demo-basic"},previewerProps:{title:"Basic",filename:"components/pagination/demo/basic.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => <Pagination defaultCurrent={1} total={50} />;
export default App;
`,description:"<p>Basic pagination.</p>"}},{demo:{id:"components-pagination-demo-more"},previewerProps:{title:"More",filename:"components/pagination/demo/more.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => <Pagination defaultCurrent={6} total={500} />;
export default App;
`,description:"<p>More pages.</p>"}},{demo:{id:"components-pagination-demo-changer"},previewerProps:{title:"Changer",filename:"components/pagination/demo/changer.tsx",jsx:`import { Pagination } from 'manyid';
...
export default App;
`,description:"<p>Change <code>pageSize</code>.</p>"}},{demo:{id:"components-pagination-demo-jump"},previewerProps:{title:"Jumper",filename:"components/pagination/demo/jump.tsx",jsx:`import { Pagination } from 'manyid';
...
export default App;
`,description:"<p>Jump to a page directly.</p>"}},{demo:{id:"components-pagination-demo-mini"},previewerProps:{title:"Mini size",filename:"components/pagination/demo/mini.tsx",jsx:`import { Pagination } from 'manyid';
...
`,description:"<p>Mini size pagination.</p>",style:`#components-pagination-demo-mini .ant-pagination:not(:last-child) {
  margin-bottom: 24px;
}`}},{demo:{id:"components-pagination-demo-simple"},previewerProps:{title:"Simple mode",filename:"components/pagination/demo/simple.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => (
  <>
...
export default App;
`,description:"<p>Simple mode.</p>"}},{demo:{id:"components-pagination-demo-controlled"},previewerProps:{title:"Controlled",filename:"components/pagination/demo/controlled.tsx",jsx:`import { Pagination } from 'manyid';
...
export default App;
`,description:"<p>Controlled page number.</p>"}},{demo:{id:"components-pagination-demo-total"},previewerProps:{title:"Total number",filename:"components/pagination/demo/total.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => (
  <>
    <Pagination
      total={85}
...
export default App;
`,description:"<p>You can show the total number of data by setting <code>showTotal</code>.</p>"}},{demo:{id:"components-pagination-demo-all"},previewerProps:{title:"Show All",filename:"components/pagination/demo/all.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => (
  <Pagination
    total={85}
    showSizeChanger
...
export default App;
`,description:"<p>Show all configured prop.</p>"}},{demo:{id:"components-pagination-demo-itemrender"},previewerProps:{title:"Prev and next",filename:"components/pagination/demo/itemRender.tsx",jsx:`import { Pagination } from 'manyid';
...
export default App;
`,description:"<p>Use text link for prev and next button.</p>"}},{demo:{id:"components-pagination-demo-wireframe"},previewerProps:{debug:!0,title:"Wireframe",filename:"components/pagination/demo/wireframe.tsx",jsx:`import { ConfigProvider, Pagination } from 'manyid';
const App = () => (
  <ConfigProvider
    theme={{
      token: {
