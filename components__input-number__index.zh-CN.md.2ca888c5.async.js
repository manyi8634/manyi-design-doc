"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[6767],{442181:function(p,l,t){t.r(l);var m=t(502143),s=t(968521),_=t(659378),c=t(631007),v=t(374912),u=t(828089),Z=t(902068),b=t(574399),E=t(863942),f=t(316073),h=t(24628),x=t(719260),g=t(956140),I=t(833531),a=t(905388),C=t(626643),A=t(606965),P=t(249706),y=t(795127),O=t(116846),D=t(73024),o=t(606641),d=t(667294),n=t(370917);function i(){var r=(0,o.eL)(),e=r.texts;return(0,n.tZ)(o.dY,null,(0,n.tZ)(d.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,n.tZ)("p",null,e[1].value),(0,n.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,n.tZ)(a.Z,{items:[{demo:{id:"components-input-number-demo-basic"},previewerProps:{title:"\u57FA\u672C",filename:"components/input-number/demo/basic.tsx",jsx:`import { InputNumber } from 'manyid';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => <InputNumber min={1} max={10} defaultValue={3} onChange={onChange} />;
export default App;
`,description:"<p>\u6570\u5B57\u8F93\u5165\u6846\u3002</p>"}},{demo:{id:"components-input-number-demo-size"},previewerProps:{title:"\u4E09\u79CD\u5927\u5C0F",filename:"components/input-number/demo/size.tsx",jsx:`import { InputNumber, Space } from 'manyid';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
export default App;
`,description:"<p>\u7528\u4E8E\u914D\u7F6E\u4E00\u4E9B\u56FA\u5B9A\u7EC4\u5408\u3002</p>"}},{demo:{id:"components-input-number-demo-disabled"},previewerProps:{title:"\u4E0D\u53EF\u7528",filename:"components/input-number/demo/disabled.tsx",jsx:`import { Button, InputNumber } from 'manyid';
...
export default App;
`,description:"<p>\u70B9\u51FB\u6309\u94AE\u5207\u6362\u53EF\u7528\u72B6\u6001\u3002</p>"}},{demo:{id:"components-input-number-demo-digit"},previewerProps:{title:"\u9AD8\u7CBE\u5EA6\u5C0F\u6570",filename:"components/input-number/demo/digit.tsx",jsx:`import { InputNumber } from 'manyid';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
export default App;
`,description:"<p>\u901A\u8FC7 <code>stringMode</code> \u5F00\u542F\u9AD8\u7CBE\u5EA6\u5C0F\u6570\u652F\u6301\uFF0C<code>onChange</code> \u4E8B\u4EF6\u5C06\u8FD4\u56DE string \u7C7B\u578B\u3002\u5BF9\u4E8E\u65E7\u7248\u6D4F\u89C8\u5668\uFF0C\u4F60\u9700\u8981 BigInt polyfill\u3002</p>"}},{demo:{id:"components-input-number-demo-formatter"},previewerProps:{title:"\u683C\u5F0F\u5316\u5C55\u793A",filename:"components/input-number/demo/formatter.tsx",jsx:`import { InputNumber, Space } from 'manyid';
const onChange = (value) => {
  console.log('changed', value);
};
const App = () => (
...
<blockquote>
<p>\u8FD9\u91CC\u6709\u4E00\u4E2A\u66F4\u590D\u6742\u7684\u8D27\u5E01\u683C\u5F0F\u5316\u8F93\u5165\u6846\uFF1A<a href="https://codesandbox.io/s/currency-wrapper-manyid-input-3ynzo">https://codesandbox.io/s/currency-wrapper-manyid-input-3ynzo</a></p>
</blockquote>`}},{demo:{id:"components-input-number-demo-keyboard"},previewerProps:{title:"\u952E\u76D8\u884C\u4E3A",filename:"components/input-number/demo/keyboard.tsx",jsx:`import { Checkbox, InputNumber, Space } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>\u4F7F\u7528 <code>keyboard</code> \u5C5E\u6027\u53EF\u4EE5\u63A7\u5236\u952E\u76D8\u884C\u4E3A\u3002</p>"}},{demo:{id:"components-input-number-demo-borderless"},previewerProps:{title:"\u65E0\u8FB9\u6846",filename:"components/input-number/demo/borderless.tsx",jsx:`import { InputNumber } from 'manyid';
const App = () => <InputNumber min={1} max={10} defaultValue={3} bordered={false} />;
export default App;
`,description:"<p>\u6CA1\u6709\u8FB9\u6846\u3002</p>"}},{demo:{id:"components-input-number-demo-out-of-range"},previewerProps:{title:"\u8D85\u51FA\u8FB9\u754C",filename:"components/input-number/demo/out-of-range.tsx",jsx:`import { Button, InputNumber, Space } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>\u53EF\u4EE5\u6269\u5C55 <code>controls</code> \u5C5E\u6027\u7528\u4EE5\u8BBE\u7F6E\u81EA\u5B9A\u4E49\u56FE\u6807\u3002</p>"}},{demo:{id:"components-input-number-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/input-number/demo/render-panel.tsx",jsx:`import { InputNumber } from 'manyid';
...
`,description:"<p>\u8C03\u8BD5\u7528\u7EC4\u4EF6\uFF0C\u8BF7\u52FF\u76F4\u63A5\u4F7F\u7528\u3002</p>"}},{demo:{id:"components-input-number-demo-debug-token"},previewerProps:{debug:!0,title:"\u8986\u76D6\u7EC4\u4EF6\u6837\u5F0F",filename:"components/input-number/demo/debug-token.tsx",jsx:`import { ConfigProvider, InputNumber, Space } from 'manyid';
export default () => (
  <ConfigProvider
    theme={{
      components: {
