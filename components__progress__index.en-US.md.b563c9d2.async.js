"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[1199],{911265:function(d,r,t){t.r(r);var u=t(502143),c=t(968521),_=t(659378),m=t(631007),v=t(374912),l=t(828089),Z=t(902068),g=t(574399),P=t(863942),h=t(316073),y=t(24628),E=t(719260),f=t(956140),x=t(833531),s=t(905388),b=t(626643),A=t(606965),D=t(249706),M=t(795127),O=t(116846),C=t(73024),o=t(606641),a=t(667294),e=t(370917);function i(){var p=(0,o.eL)(),n=p.texts;return(0,e.tZ)(o.dY,null,(0,e.tZ)(a.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("p",null,n[1].value,(0,e.tZ)("code",null,n[2].value),n[3].value),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[4].value),(0,e.tZ)("li",null,n[5].value)),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(s.Z,{items:[{demo:{id:"components-progress-demo-line"},previewerProps:{title:"Progress bar",filename:"components/progress/demo/line.tsx",jsx:`import { Progress } from 'manyid';
const App = () => (
  <>
    <Progress percent={30} />
...
export default App;
`,description:"<p>A standard progress bar.</p>"}},{demo:{id:"components-progress-demo-circle"},previewerProps:{title:"Circular progress bar",filename:"components/progress/demo/circle.tsx",jsx:`import { Progress, Space } from 'manyid';
const App = () => (
  <Space wrap>
...
export default App;
`,description:"<p>A circular progress bar.</p>"}},{demo:{id:"components-progress-demo-line-mini"},previewerProps:{title:"Mini size progress bar",filename:"components/progress/demo/line-mini.tsx",jsx:`import { Progress } from 'manyid';
const App = () => (
  <div
    style={{
      width: 170,
...
export default App;
`,description:"<p>Appropriate for a narrow area.</p>"}},{demo:{id:"components-progress-demo-circle-micro"},previewerProps:{title:"Responsive circular progress bar",filename:"components/progress/demo/circle-micro.tsx",jsx:`import { Progress } from 'manyid';
const App = () => (
  <>
    <Progress
      type="circle"
...
export default App;
`,description:"<p>A dynamic progress bar is better.</p>"}},{demo:{id:"components-progress-demo-format"},previewerProps:{title:"Custom text format",filename:"components/progress/demo/format.tsx",jsx:`import { Progress, Space } from 'manyid';
const App = () => (
  <Space wrap>
...
export default App;
`,description:"<p>You can set a custom text by setting the <code>format</code> prop.</p>"}},{demo:{id:"components-progress-demo-dashboard"},previewerProps:{title:"Dashboard",filename:"components/progress/demo/dashboard.tsx",jsx:`import { Progress, Space } from 'manyid';
const App = () => (
  <Space wrap>
...
export default App;
`,description:`<p>A standard progress bar. Doesn't support trail color when <code>type="circle|dashboard"</code>.</p>`}},{demo:{id:"components-progress-demo-linecap"},previewerProps:{title:"Stroke Linecap",filename:"components/progress/demo/linecap.tsx",jsx:`import { Progress, Space } from 'manyid';
const App = () => (
  <>
...
export default App;
`,description:'<p>By setting <code>strokeLinecap="butt"</code>, you can change the linecaps from <code>round</code> to <code>butt</code>, see <a href="https://developer.mozilla.org/docs/Web/SVG/Attribute/stroke-linecap">stroke-linecap</a> for more information.</p>'}},{demo:{id:"components-progress-demo-gradient-line"},previewerProps:{title:"Custom line gradient",filename:"components/progress/demo/gradient-line.tsx",jsx:`import { Progress, Space } from 'manyid';
const App = () => (
  <>
    <Progress
      percent={99.9}
...
export default App;
`,description:"<p>A progress bar with steps.</p>"}},{demo:{id:"components-progress-demo-size"},previewerProps:{title:"Progress size",filename:"components/progress/demo/size.tsx",jsx:`import { Progress, Space } from 'manyid';
const App = () => (
  <>
