"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[9582],{644601:function(r,o,n){n.r(o);var _=n(502143),c=n(968521),p=n(659378),v=n(631007),m=n(374912),l=n(828089),Z=n(902068),h=n(574399),E=n(863942),g=n(316073),S=n(24628),k=n(719260),x=n(956140),f=n(833531),u=n(905388),P=n(626643),y=n(606965),D=n(249706),B=n(795127),A=n(116846),I=n(73024),a=n(606641),i=n(667294),t=n(370917);function d(){var s=(0,a.eL)(),e=s.texts;return(0,t.tZ)(a.dY,null,(0,t.tZ)(i.Fragment,null,(0,t.tZ)("div",{className:"markdown"},(0,t.tZ)("p",null,e[0].value),(0,t.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,t.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,t.tZ)("ul",null,(0,t.tZ)("li",null,e[1].value),(0,t.tZ)("li",null,e[2].value),(0,t.tZ)("li",null,e[3].value),(0,t.tZ)("li",null,e[4].value)),(0,t.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,t.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,t.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,t.tZ)(u.Z,{items:[{demo:{id:"components-skeleton-demo-basic"},previewerProps:{title:"\u57FA\u672C",filename:"components/skeleton/demo/basic.tsx",jsx:`import { Skeleton } from 'manyid';
const App = () => <Skeleton />;
export default App;
`,description:"<p>\u6700\u7B80\u5355\u7684\u5360\u4F4D\u6548\u679C\u3002</p>"}},{demo:{id:"components-skeleton-demo-complex"},previewerProps:{title:"\u590D\u6742\u7684\u7EC4\u5408",filename:"components/skeleton/demo/complex.tsx",jsx:`import { Skeleton } from 'manyid';
const App = () => (
  <Skeleton
    avatar
    paragraph={{
...
export default App;
`,description:"<p>\u66F4\u590D\u6742\u7684\u7EC4\u5408\u3002</p>"}},{demo:{id:"components-skeleton-demo-active"},previewerProps:{title:"\u52A8\u753B\u6548\u679C",filename:"components/skeleton/demo/active.tsx",jsx:`import { Skeleton } from 'manyid';
...
export default App;
`,description:"<p>\u9AA8\u67B6\u6309\u94AE\u3001\u5934\u50CF\u3001\u8F93\u5165\u6846\u3001\u56FE\u50CF\u548C\u81EA\u5B9A\u4E49\u8282\u70B9\u3002</p>"}},{demo:{id:"components-skeleton-demo-children"},previewerProps:{title:"\u5305\u542B\u5B50\u7EC4\u4EF6",filename:"components/skeleton/demo/children.tsx",jsx:`import { Button, Skeleton, Space } from 'manyid';
import { useState } from 'react';
const App = () => {
