"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[48],{68537:function(d,l,e){e.r(l);var p=e(502143),c=e(968521),m=e(659378),v=e(631007),_=e(374912),s=e(828089),Z=e(902068),h=e(574399),g=e(863942),S=e(316073),f=e(24628),x=e(719260),P=e(956140),E=e(833531),o=e(905388),y=e(626643),T=e(606965),C=e(249706),D=e(795127),A=e(116846),b=e(73024),i=e(606641),r=e(667294),n=e(370917);function a(){var u=(0,i.eL)(),t=u.texts;return(0,n.tZ)(i.dY,null,(0,n.tZ)(r.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,(0,n.tZ)("code",null,t[0].value),t[1].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("p",null,t[2].value),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(o.Z,{items:[{demo:{id:"components-steps-demo-simple"},previewerProps:{title:"Basic",filename:"components/steps/demo/simple.tsx",jsx:`import { Steps } from 'manyid';
...
export default App;
`,description:"<p>The most basic step bar.</p>"}},{demo:{id:"components-steps-demo-small-size"},previewerProps:{title:"Mini version",filename:"components/steps/demo/small-size.tsx",jsx:`import { Steps } from 'manyid';
const App = () => (
  <Steps
    size="small"
    current={1}
...
export default App;
`,description:"<p>You can use your own custom icons by setting the property <code>icon</code> for <code>items</code>.</p>"}},{demo:{id:"components-steps-demo-step-next"},previewerProps:{title:"Switch Step",filename:"components/steps/demo/step-next.tsx",jsx:`import { Button, message, Steps, theme } from 'manyid';
...
export default App;
`,description:"<p>Cooperate with the content and buttons, to represent the progress of a process.</p>"}},{demo:{id:"components-steps-demo-vertical"},previewerProps:{title:"Vertical",filename:"components/steps/demo/vertical.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description.';
const App = () => (
  <Steps
    direction="vertical"
...
export default App;
`,description:"<p>A simple step bar in the vertical direction.</p>"}},{demo:{id:"components-steps-demo-vertical-small"},previewerProps:{title:"Vertical mini version",filename:"components/steps/demo/vertical-small.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description.';
const App = () => (
  <Steps
    direction="vertical"
...
export default App;
`,description:"<p>A simple mini version step bar in the vertical direction.</p>"}},{demo:{id:"components-steps-demo-error"},previewerProps:{title:"Error status",filename:"components/steps/demo/error.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description';
const App = () => (
  <Steps
    current={1}
...
export default App;
`,description:"<p>By using <code>status</code> of <code>Steps</code>, you can specify the state for current step.</p>"}},{demo:{id:"components-steps-demo-progress-dot"},previewerProps:{title:"Dot Style",filename:"components/steps/demo/progress-dot.tsx",jsx:`import { Divider, Steps } from 'manyid';
const App = () => (
  <>
    <Steps
      progressDot
...
export default App;
`,description:"<p>Steps with progress dot style.</p>"}},{demo:{id:"components-steps-demo-customized-progress-dot"},previewerProps:{title:"Customized Dot Style",filename:"components/steps/demo/customized-progress-dot.tsx",jsx:`import { Popover, Steps } from 'manyid';
...
export default App;
`,description:"<p>You can customize the display for Steps with progress dot style.</p>"}},{demo:{id:"components-steps-demo-progress-dot-small"},previewerProps:{debug:!0,title:"Dot Style Size Small",filename:"components/steps/demo/progress-dot-small.tsx",jsx:`import { Divider, Steps } from 'manyid';
const App = () => (
  <>
    <Steps
      progressDot
...
export default App;
`,description:"<p>Steps with progress dot style.</p>"}},{demo:{id:"components-steps-demo-clickable"},previewerProps:{title:"Clickable",filename:"components/steps/demo/clickable.tsx",jsx:`import { Divider, Steps } from 'manyid';
import { useState } from 'react';
const App = () => {
  const [current, setCurrent] = useState(0);
...
export default App;
`,description:"<p>Setting <code>onChange</code> makes Steps clickable.</p>"}},{demo:{id:"components-steps-demo-nav"},previewerProps:{title:"Navigation Steps",filename:"components/steps/demo/nav.tsx",jsx:`import { Steps } from 'manyid';
import { useState } from 'react';
const App = () => {
  const [current, setCurrent] = useState(0);
  const onChange = (value) => {
...
export default App;
`,description:"<p>Navigation steps.</p>"}},{demo:{id:"components-steps-demo-progress"},previewerProps:{title:"Steps with progress",filename:"components/steps/demo/progress.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description.';
const App = () => (
  <Steps
    current={1}
...
export default App;
`,description:"<p>Steps with progress.</p>"}},{demo:{id:"components-steps-demo-label-placement"},previewerProps:{title:"Label Placement",filename:"components/steps/demo/label-placement.tsx",jsx:`import { Steps } from 'manyid';
const description = 'This is a description.';
const items = [
  {
    title: 'Finished',
...
export default App;
`,description:"<p>Set labelPlacement to <code>vertical</code>.</p>"}},{demo:{id:"components-steps-demo-progress-debug"},previewerProps:{debug:!0,title:"Progress Debug",filename:"components/steps/demo/progress-debug.tsx",jsx:`import { Button, Space, Steps } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>Buggy!</p>"}},{demo:{id:"components-steps-demo-steps-in-steps"},previewerProps:{debug:!0,title:"Steps inside Steps",filename:"components/steps/demo/steps-in-steps.tsx",jsx:`import { Card, Radio, Steps } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>Test style of Steps inside Steps.</p>"}},{demo:{id:"components-steps-demo-inline"},previewerProps:{title:"Inline Steps",filename:"components/steps/demo/inline.tsx",jsx:`import { Avatar, List, Steps } from 'manyid';
const data = [
  {
...
export default App;
`,description:"<p>Inline type steps, suitable for displaying the process and current state of the object in the list content scene.</p>"}},{demo:{id:"components-steps-demo-wireframe"},previewerProps:{debug:!0,title:"Wireframe",filename:"components/steps/demo/wireframe.tsx",jsx:`import { ConfigProvider, Steps } from 'manyid';
const description = 'This is a description.';
const App = () => (
  <ConfigProvider
    theme={{
