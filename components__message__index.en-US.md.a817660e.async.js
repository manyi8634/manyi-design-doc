"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[6518],{241603:function(m,s,t){t.r(s);var _=t(502143),r=t(968521),p=t(659378),Z=t(631007),a=t(374912),o=t(828089),v=t(902068),g=t(574399),h=t(863942),x=t(316073),E=t(24628),f=t(719260),y=t(956140),P=t(833531),u=t(905388),A=t(626643),D=t(606965),M=t(249706),C=t(795127),B=t(116846),O=t(73024),l=t(606641),i=t(667294),e=t(370917);function d(){var c=(0,l.eL)(),n=c.texts;return(0,e.tZ)(l.dY,null,(0,e.tZ)(i.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value),(0,e.tZ)("li",null,n[2].value)),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(u.Z,{items:[{demo:{id:"components-message-demo-hooks"},previewerProps:{title:"Hooks usage (recommended)",filename:"components/message/demo/hooks.tsx",jsx:`import { Button, message } from 'manyid';
const App = () => {
...
export default App;
`,description:"<p>Messages of success, error and warning types.</p>"}},{demo:{id:"components-message-demo-duration"},previewerProps:{title:"Customize duration",filename:"components/message/demo/duration.tsx",jsx:`import { Button, message } from 'manyid';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi.open({
...
export default App;
`,description:"<p>Customize message display duration from default <code>3s</code> to <code>10s</code>.</p>"}},{demo:{id:"components-message-demo-loading"},previewerProps:{title:"Message with loading indicator",filename:"components/message/demo/loading.tsx",jsx:`import { Button, message } from 'manyid';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi.open({
...
export default App;
`,description:"<p>Display a global loading indicator, which is dismissed by itself asynchronously.</p>"}},{demo:{id:"components-message-demo-thenable"},previewerProps:{title:"Promise interface",filename:"components/message/demo/thenable.tsx",jsx:`import { Button, message } from 'manyid';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi
...
export default App;
`,description:"<p><code>message</code> provides a promise interface for <code>onClose</code>. The above example will display a new message when the old message is about to close.</p>"}},{demo:{id:"components-message-demo-custom-style"},previewerProps:{title:"Customized style",filename:"components/message/demo/custom-style.tsx",jsx:`import { Button, message } from 'manyid';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const success = () => {
    messageApi.open({
...
export default App;
`,description:"<p>The <code>style</code> and <code>className</code> are available to customize Message.</p>"}},{demo:{id:"components-message-demo-update"},previewerProps:{title:"Update Message Content",filename:"components/message/demo/update.tsx",jsx:`import { Button, message } from 'manyid';
const App = () => {
  const [messageApi, contextHolder] = message.useMessage();
  const key = 'updatable';
  const openMessage = () => {
...
export default App;
`,description:"<p>Update message content with unique <code>key</code>.</p>"}},{demo:{id:"components-message-demo-info"},previewerProps:{title:"Normal prompt",filename:"components/message/demo/info.tsx",jsx:`import { Button, message } from 'manyid';
const info = () => {
...
export default App;
`,description:"<p>Normal message for information.</p>"}},{demo:{id:"components-message-demo-render-panel"},previewerProps:{debug:!0,title:"_InternalPanelDoNotUseOrYouWillBeFired",filename:"components/message/demo/render-panel.tsx",jsx:`import { message } from 'manyid';
