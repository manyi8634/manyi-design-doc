"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[6299],{321713:function(r,l,e){e.r(l);var m=e(502143),p=e(968521),Z=e(659378),v=e(631007),o=e(374912),i=e(828089),c=e(902068),g=e(574399),P=e(863942),E=e(316073),h=e(24628),x=e(719260),C=e(956140),f=e(833531),u=e(905388),A=e(626643),D=e(606965),M=e(249706),O=e(795127),T=e(116846),j=e(73024),a=e(606641),d=e(667294),n=e(370917);function _(){var s=(0,a.eL)(),t=s.texts;return(0,n.tZ)(a.dY,null,(0,n.tZ)(d.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,t[0].value),(0,n.tZ)("h2",{id:"\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4F55\u65F6\u4F7F\u7528"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4F55\u65F6\u4F7F\u7528"),(0,n.tZ)("ul",null,(0,n.tZ)("li",null,t[1].value),(0,n.tZ)("li",null,t[2].value)),(0,n.tZ)("h2",{id:"\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#\u4EE3\u7801\u6F14\u793A"},(0,n.tZ)("span",{className:"icon icon-link"})),"\u4EE3\u7801\u6F14\u793A")),(0,n.tZ)(u.Z,{items:[{demo:{id:"components-pagination-demo-basic"},previewerProps:{title:"\u57FA\u672C",filename:"components/pagination/demo/basic.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => <Pagination defaultCurrent={1} total={50} />;
export default App;
`,description:"<p>\u57FA\u7840\u5206\u9875\u3002</p>"}},{demo:{id:"components-pagination-demo-more"},previewerProps:{title:"\u66F4\u591A",filename:"components/pagination/demo/more.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => <Pagination defaultCurrent={6} total={500} />;
export default App;
`,description:"<p>\u66F4\u591A\u5206\u9875\u3002</p>"}},{demo:{id:"components-pagination-demo-changer"},previewerProps:{title:"\u6539\u53D8",filename:"components/pagination/demo/changer.tsx",jsx:`import { Pagination } from 'manyid';
...
export default App;
`,description:"<p>\u6539\u53D8\u6BCF\u9875\u663E\u793A\u6761\u76EE\u6570\u3002</p>"}},{demo:{id:"components-pagination-demo-jump"},previewerProps:{title:"\u8DF3\u8F6C",filename:"components/pagination/demo/jump.tsx",jsx:`import { Pagination } from 'manyid';
...
export default App;
`,description:"<p>\u5FEB\u901F\u8DF3\u8F6C\u5230\u67D0\u4E00\u9875\u3002</p>"}},{demo:{id:"components-pagination-demo-mini"},previewerProps:{title:"\u8FF7\u4F60",filename:"components/pagination/demo/mini.tsx",jsx:`import { Pagination } from 'manyid';
...
`,description:"<p>\u8FF7\u4F60\u7248\u672C\u3002</p>",style:`#components-pagination-demo-mini .ant-pagination:not(:last-child) {
  margin-bottom: 24px;
}`}},{demo:{id:"components-pagination-demo-simple"},previewerProps:{title:"\u7B80\u6D01",filename:"components/pagination/demo/simple.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => (
  <>
...
export default App;
`,description:"<p>\u7B80\u5355\u7684\u7FFB\u9875\u3002</p>"}},{demo:{id:"components-pagination-demo-controlled"},previewerProps:{title:"\u53D7\u63A7",filename:"components/pagination/demo/controlled.tsx",jsx:`import { Pagination } from 'manyid';
...
export default App;
`,description:"<p>\u53D7\u63A7\u5236\u7684\u9875\u7801\u3002</p>"}},{demo:{id:"components-pagination-demo-total"},previewerProps:{title:"\u603B\u6570",filename:"components/pagination/demo/total.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => (
  <>
    <Pagination
      total={85}
...
export default App;
`,description:"<p>\u901A\u8FC7\u8BBE\u7F6E <code>showTotal</code> \u5C55\u793A\u603B\u5171\u6709\u591A\u5C11\u6570\u636E\u3002</p>"}},{demo:{id:"components-pagination-demo-all"},previewerProps:{title:"\u5168\u90E8\u5C55\u793A",filename:"components/pagination/demo/all.tsx",jsx:`import { Pagination } from 'manyid';
const App = () => (
  <Pagination
    total={85}
    showSizeChanger
...
export default App;
`,description:"<p>\u5C55\u793A\u6240\u6709\u914D\u7F6E\u9009\u9879\u3002</p>"}},{demo:{id:"components-pagination-demo-itemrender"},previewerProps:{title:"\u4E0A\u4E00\u6B65\u548C\u4E0B\u4E00\u6B65",filename:"components/pagination/demo/itemRender.tsx",jsx:`import { Pagination } from 'manyid';
...
export default App;
`,description:"<p>\u4FEE\u6539\u4E0A\u4E00\u6B65\u548C\u4E0B\u4E00\u6B65\u4E3A\u6587\u5B57\u94FE\u63A5\u3002</p>"}},{demo:{id:"components-pagination-demo-wireframe"},previewerProps:{debug:!0,title:"\u7EBF\u6846\u98CE\u683C",filename:"components/pagination/demo/wireframe.tsx",jsx:`import { ConfigProvider, Pagination } from 'manyid';
const App = () => (
  <ConfigProvider
    theme={{
      token: {
