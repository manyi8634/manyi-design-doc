"use strict";(self.webpackChunkmanyid=self.webpackChunkmanyid||[]).push([[6341],{704773:function(s,u,t){t.r(u);var p=t(502143),_=t(968521),m=t(659378),c=t(631007),v=t(374912),l=t(828089),Z=t(902068),h=t(574399),f=t(863942),g=t(316073),E=t(24628),x=t(719260),C=t(956140),P=t(833531),d=t(905388),b=t(626643),y=t(606965),S=t(249706),D=t(795127),A=t(116846),O=t(73024),a=t(606641),o=t(667294),e=t(370917);function i(){var r=(0,a.eL)(),n=r.texts;return(0,e.tZ)(a.dY,null,(0,e.tZ)(o.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("p",null,n[1].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(d.Z,{items:[{demo:{id:"components-slider-demo-basic"},previewerProps:{title:"Basic",filename:"components/slider/demo/basic.tsx",jsx:`import { Slider, Switch } from 'manyid';
...
.icon-wrapper .anticon:last-child {
  right: 0;
}`}},{demo:{id:"components-slider-demo-tip-formatter"},previewerProps:{title:"Customize tooltip",filename:"components/slider/demo/tip-formatter.tsx",jsx:`import { Slider } from 'manyid';
...
export default App;
`,description:"<p>Use <code>tooltip.formatter</code> to format content of <code>Tooltip</code>. If <code>tooltip.formatter</code> is null, hide it.</p>"}},{demo:{id:"components-slider-demo-event"},previewerProps:{title:"Event",filename:"components/slider/demo/event.tsx",jsx:`import { Slider } from 'manyid';
const onChange = (value) => {
...
export default App;
`,description:"<p>The <code>onChange</code> callback function will fire when the user changes the slider's value. The <code>onAfterChange</code> callback function will fire when <code>onmouseup</code> fired.</p>"}},{demo:{id:"components-slider-demo-mark"},previewerProps:{title:"Graduated slider",filename:"components/slider/demo/mark.tsx",jsx:`import { Slider } from 'manyid';
const marks = {
  0: '0\xB0C',
  26: '26\xB0C',
  37: '37\xB0C',
...
#components-slider-demo-mark .ant-slider-with-marks {
  margin-bottom: 44px;
}`}},{demo:{id:"components-slider-demo-vertical"},previewerProps:{title:"Vertical",filename:"components/slider/demo/vertical.tsx",jsx:`import { Slider } from 'manyid';
const style = {
...
export default App;
`,description:"<p>The vertical Slider.</p>"}},{demo:{id:"components-slider-demo-show-tooltip"},previewerProps:{title:"Control visible of ToolTip",filename:"components/slider/demo/show-tooltip.tsx",jsx:`import { Slider } from 'manyid';
const App = () => (
  <Slider
    defaultValue={30}
    tooltip={{
...
export default App;
`,description:"<p>When <code>tooltip.open</code> is <code>true</code>, ToolTip will always show, or ToolTip will not show anyway, even if dragging or hovering.</p>"}},{demo:{id:"components-slider-demo-reverse"},previewerProps:{title:"Reverse",filename:"components/slider/demo/reverse.tsx",jsx:`import { Slider, Switch } from 'manyid';
import { useState } from 'react';
const App = () => {
...
export default App;
`,description:"<p>Using <code>reverse</code> to render slider reversely.</p>"}},{demo:{id:"components-slider-demo-draggabletrack"},previewerProps:{title:"Draggable track",filename:"components/slider/demo/draggableTrack.tsx",jsx:`import { Slider } from 'manyid';
const App = () => (
  <Slider
    range={{
      draggableTrack: true,
